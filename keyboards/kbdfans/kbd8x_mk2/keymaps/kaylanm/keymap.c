...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT( /* Function */
	...
	RESET,            AG_TOGG, _______, _______, _______,      _______, _______, _______, _______,     _______, _______, _______, _______,          KC_SLEP, _______, _______, \
	_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_BSPC,          KC_MUTE, KC_VOLU, KC_MPLY, \
	KC_CAPS, _______, KC_PGUP, _______, _______, _______, _______, _______, KC_UP,   _______, KC_MPRV, KC_MPLY, KC_MNXT,          _______,          KC_MPRV, KC_VOLD, KC_MNXT, \
