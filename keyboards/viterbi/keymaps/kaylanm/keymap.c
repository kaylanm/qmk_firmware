 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Up| Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |  Up  | Esc  |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * | Pg Dn| Ctrl | Alt  | GUI  |Lower |BackSp|Space |      |Space |  Del |Raise | Ctrl | Left | Down | Right|
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_QWERTY] = KC_KEYMAP(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     END, CAPS, A  , S  , D  , F  , G  ,      H  , J  , K  , L  ,SCLN,QUOT,ENT ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGUP,LSFT, Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT ,SLSH, UP ,ESC ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGDN,LCTL,LALT,LGUI,LOWR,BSPC,SPC ,     SPC ,DEL ,RASE,RCTL,LEFT,DOWN,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
