...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  | NumP |Lower |Space |Space |Raise | KANA | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, NUMPAD,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   */
  [_NUMPAD] = LAYOUT( \
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, \
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                      KC_Y,    KC_U,    KC_P7,   KC_P8,   KC_P9,   KC_PPLS, \
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_P4,   KC_P5,   KC_P6,   KC_PPLS, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_P1,   KC_P2,   KC_P3,   KC_PENT, \
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, NUMPAD,  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KANA,    KC_P0,   KC_P0,   KC_PDOT, KC_PENT \
      )
};
